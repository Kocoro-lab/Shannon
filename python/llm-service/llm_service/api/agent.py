...
async def decompose_task(request: Request, query: AgentQuery) -> DecompositionResponse:
    ...
    try:
        ...
        COMMON_DECOMPOSITION_SUFFIX = (
            ...
            "USE TOOLS WHEN:\n"
            "- web_fetch: When user mentions ANY domain or URL to read/summarize/analyze (e.g., 'summarize example.com', 'this site: foo.com', 'read https://...')\n"
            "- web_search: ONLY when searching for information WITHOUT a specific domain (news, research, general questions)\n"
            ...
            "CRITICAL web_fetch vs web_search:\n"
        ...
        RESEARCH_SUPERVISOR_IDENTITY = (
            ...
            "2. **Starting Points** (1 sentence): Specific sites/queries to try first\n"
