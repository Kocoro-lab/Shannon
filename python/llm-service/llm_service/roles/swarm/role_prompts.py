...
SWARM_ROLE_PROMPTS: Dict[str, str] = {
    ...
    "company_researcher": (
        ...
        "- Keep brand names AS-IS in all languages: 'Notion 料金' not 'ノーション 料金'\n"
        ...
        "  Task: 'Research SpaceX revenue and valuation'\n"
        "  THINK: SpaceX is private. Revenue won't be in search snippets.\n"
        "  I need primary sources: press releases, TechCrunch funding articles.\n"
        "  → web_search('SpaceX revenue 2025 valuation funding round')\n"
        "  → Got URLs: techcrunch.com/spacex-funding, bloomberg.com/spacex-valuation\n"
