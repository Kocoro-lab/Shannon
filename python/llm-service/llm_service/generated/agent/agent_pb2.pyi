...
class TaskUpdate(_message.Message):
    __slots__ = ("task_id", "state", "message", "tool_call", "tool_result", "progress")
    TASK_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    progress: float
    def __init__(self, task_id: _Optional[str] = ..., state: _Optional[_Union[AgentState, str]] = ..., message: _Optional[str] = ..., tool_call: _Optional[_Union[_common_pb2.ToolCall, _Mapping]] = ..., tool_result: _Optional[_Union[_common_pb2.ToolResult, _Mapping]] = ..., progress: _Optional[float] = ...) -> None: ...
