...
class LLMProvider(ABC):
    ...
    def select_model_for_tier(self, tier: ModelTier, max_tokens: Optional[int] = None) -> ModelConfig:
        ...
        if max_tokens:
            ...
            if not tier_models:
                raise ValueError(f"No models in tier {tier} support {max_tokens} tokens")
...
class LLMProviderRegistry:
    ...
    def select_provider_for_request(self, request: CompletionRequest) -> tuple[str, LLMProvider]:
